        ...
        <div class="mx-auto">
            ...
            <div>
                ...
                <div class="container mx-auto">
                    <p class="text-red-700 text-2xl font-bold pt-10 pl-8 lg:pt-10">Nuestros productos</p>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 py-10">
                        <div class="contenedor mx-auto">
                            <a href="{{route('catalogo.enlaces', ['cat' => 3, 'niv' => 3])}}">
                        ...
                        <div class="contenedor mx-auto">
                            <a href="{{route('catalogo.enlaces', ['cat' => 4, 'niv' => 3])}}">
                        ...
                        <div class="contenedor mx-auto">
                            <a href="{{route('catalogo.enlaces', ['cat' => 6, 'niv' => 1])}}">
                        ...
                        <div class="my-20 h-96 w-full flex flex-col justify-center items-center">
                            <div class="w-11/12 relative overflow-x: hidden; flex">
                                ...
                                <div id="showcase2" class="noselect">
                                    <a href="{{route('catalogo.enlaces_marcas', 22)}}"><img class="cloud9-item" src="{{asset('img/canon.png')}}" alt="Canon"></a>
                                    <a href="{{route('catalogo.enlaces_marcas', 9)}}"><img class="cloud9-item" src="{{asset('img/ricoh.png')}}" alt="Ricoh"></a>
                                    <a href="{{route('catalogo.enlaces_marcas', 10)}}"><img class="cloud9-item" src="{{asset('img/konica.png')}}" alt="Konica Minolta"></a>
                                    <a href="{{route('catalogo.enlaces_marcas', 11)}}"><img class="cloud9-item" src="{{asset('img/keyocera.png')}}" alt="Kyocera"></a>
                                </div>
